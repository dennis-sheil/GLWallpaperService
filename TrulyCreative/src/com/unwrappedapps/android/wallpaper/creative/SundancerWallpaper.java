...
public class SundancerWallpaper extends ARenderer {

    private static native void nativeSettings(String hack, String hackPref, int draw);
    public static final String SHARED_PREFS_NAME="sundancersettings";
    CallNative cn;
    ...
    void doSP(SharedPreferences sspp) {
        String hackPref = sspp.getString("sundancer_quad", "75"); // key
        String hack = "sundancer";
